...
namespace RootMotion.FinalIK {
	...
	public class IKSolverTrigonometric: IKSolver {
		...
		public static void Solve(Transform bone1, Transform bone2, Transform bone3, Vector3 targetPosition, Vector3 bendNormal, float weight) {
			...
			bone1.rotation = Quaternion.FromToRotation(bone2.position - bone1.position, toBendPoint) * bone1.rotation;
			bone2.rotation = Quaternion.FromToRotation(bone3.position - bone2.position, targetPosition - bone2.position) * bone2.rotation;
		}
		...
		public static void SolveVirtual(IKSolver.Bone[] bones, int first, int second, int third, Vector3 targetPosition, Vector3 bendNormal, float weight) {
			...
			SolverRotateBonesAroundPoint(bones, first, bones[first].solverPosition, q1);
			...
			SolverRotateBonesAroundPoint(bones, second, bones[second].solverPosition, q2);
		}
